...
def get_hexagonal_bs(radius=2000):
...
def get_random_users(n=100, area_range=5000):
...
if __name__ == "__main__":
    ...
    ue_coords = get_random_users(n=100, area_range=5000) # UEs are distributed within 10 Km x 10 Km area.
